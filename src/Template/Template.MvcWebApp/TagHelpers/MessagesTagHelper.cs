...
using static Template.MvcWebApp.Models.ResponseMessageViewModel;
...
namespace Template.MvcWebApp.TagHelpers
{
    ...
    public class MessagesTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            {
                failureResponse = ViewContext.TempData[TempDataKey.MESSAGE_RESPONSE] as ResponseMessageViewModel;
            }
