...
namespace Template.WebApp.Middlewares
{
    public class LogExceptionMiddleware
    {
        ...
        public LogExceptionMiddleware(RequestDelegate next, IOptions<LoggingOptions> options, ILogger<LogExceptionMiddleware> logger)
        {
        ...
        public LogExceptionMiddleware(RequestDelegate next, LoggingOptions options, ILogger<LogExceptionMiddleware> logger)
        {
            this.next = next ?? throw new ArgumentNullException(nameof(next));
